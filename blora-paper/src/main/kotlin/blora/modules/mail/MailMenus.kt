...
fun systemMailManagementMenu(
    ...
    return Menu(
        ...
        component {
            localization(player) {
                this.menuSystem_mail_managementTitle
            }
        },
        { menu ->
            menu.destroy()
                            ...
                            tags = {
                                componentPlaceholder("sender") {
                                    if (systemMail.sender != null) {
                                        ...
                                        localization(player) {
                                            "<italic:false><white>" + this.mailSenderSystemDefault
                                        }
                                    }
                                }
                            }
                        ) {
                            "<italic:false><white>" + this.mailTooltipSender
                        }
                        newline()
                        localization(
                            player = player,
                        ...
                        localization(
                            ...
                            tags = {
                                componentPlaceholder("creator") {
                                    text {
                                        BloraPlugin.database.getCreatorDisplayName(systemMail)
                                    } without italic with white.text
                                }
                            }
                        ) {
                            "<italic:false><white>" + this.mailTooltipCreator
                        }
                        newline()
                        localization(
                            player = player,
                            ...
                            when (trigger) {
                                is OnlineInRangeTrigger -> {
                                    ...
                                    localization(
                                        ...
                                        "<italic:false><white>" + this.mailSystemTooltipTriggerOnline_in_range
                                    }
                                }
                                ...
                                is OnlineBeforeTrigger -> {
                                    ...
                                    localization(
                                        ...
                                        "<italic:false><white>" + this.mailSystemTooltipTriggerOnline_before
                                    }
                                }
                                ...
                                is OnlineInRecentDaysTrigger -> {
                                    ...
                                    localization(
                                        ...
                                        "<italic:false><white>" + if (trigger.days == 0) {
                                            this.mailSystemTooltipTriggerOnline_in_recent_days_0
                                        } else {
                                            this.mailSystemTooltipTriggerOnline_in_recent_days
                                        }
                                    }
                                }
                            }
                                ...
                                componentPlaceholder("status") {
                                    localization(player) {
                                        if (systemMail.actived) {
                                            this.mailSystemTooltipStatusActivated
                                        } else {
                                            this.mailSystemTooltipStatusInactivated
                                        }
                                    }
                                }
                            }
                        ) {
                            this.mailSystemTooltipStatus
                        }
                        newline()
                        newline()
                        localization(player) {
                            this.mailTooltipManagementLeft_click
                        }
                        newline()
                        localization(player) {
                            this.mailTooltipManagementRight_click
                        }
                    }
                }
        ...
        ((counterIndex / 7) + 2) to (counterIndex - ((counterIndex / 7) * 7) + 2) eq {
            ...
            hoverText {
                ...
                description {
                    ...
                    newline()
                    localization(player) {
                        "<italic:false><white>" + this.mailTooltipView
                    }
                }
            }
            clickEvent { clickContext ->
...
fun createSystemMailMenu(player: Player): Menu {
    return Menu(CreatingMailContext(), player, 5, component {
        localization(player) {
            this.menuCreate_system_mailTitle
        }
    }, {
        ...
        2 to 2 eq {
            ...
            hoverText { menu ->
                title {
                    localization(player) {
                        this.menuCreate_system_mailButtonModify_title
                    }
                }
            ...
            clickEvent {
                ...
                player.openDialog(
                    modifyMailTitleDialog(player, it.menu, it.menu.contextObject)
                )
            }
        }
        2 to 5 eq {
            ...
            hoverText { menu ->
                title {
                    localization(player) {
                        this.menuCreate_system_mailButtonModify_system_sender
                    }
                }
            ...
            clickEvent {
                (it.menu.contextObject as CreatingMailContext).modifying = true
                player.openDialog(
                    modifyMailSystemSenderDialog(player, it.menu, it.menu.contextObject)
                )
            }
        }
        2 to 8 eq {
            ...
            hoverText { menu ->
                title {
                    localization(player) {
                        this.menuCreate_system_mailButtonModify_contents
                    }
                }
            ...
            clickEvent {
                (it.menu.contextObject as CreatingMailContext).modifying = true
                player.openDialog(
                    modifyMailContentsDialog(player, it.menu, it.menu.contextObject)
                )
            }
        }
        4 to 2 eq {
            ...
            hoverText {
                title {
                    localization(player) {
                        this.menuCreate_system_mailButtonModify_trigger
                    }
                }
            }
            clickEvent {
        ...
        4 to 5 eq {
            ...
            hoverText {
                title {
                    localization(player) {
                        this.menuCreate_system_mailButtonModify_attachment
                    }
                }
            }
            clickEvent {
        ...
        4 to 8 eq {
            ...
            hoverText {
                title {
                    localization(player) {
                        this.menuCreate_system_mailButtonModify_date
                    }
                }
                description {
                    if ((it.contextObject as CreatingMailContext).date != null) {
                        ...
                        newline()
                        localization(player) {
                            this.menuCreate_system_mailButtonModify_dateDescriptionTooltip1
                        }
                        newline()
                        localization(player) {
                            this.menuCreate_system_mailButtonModify_dateDescriptionTooltip2
                        }
                    } else {
                        newline()
                        localization(player) {
                            this.menuCreate_system_mailButtonModify_dateDescriptionNot_set
                        }
                    }
                }
            }
                        ...
                        modifyDateTimeDialog(
                            ...
                            component {
                                localization(clickContext.menu.viewer) {
                                    this.dialogModify_datetimeModify_receive_dateTitle
                                }
                            },
                            yesCallback = { date ->
                                context.date = date
        ...
        5 to 9 eq {
            ...
            hoverText {
                title {
                    localization(player) {
                        this.menuCreate_system_mailButtonCreate
                    }
                }
            }
            clickEvent { clickContext ->
                if (clickContext.clickType.isLeftClick) {
                    ...
                    if (creatingContext.title.isEmpty()) {
                        player.send {
                            localization(player) {
                                this.menuCreate_system_mailWarningTitle_cannot_be_empty
                            }
                        }
                        return@clickEvent
                    }
                    ...
                    if (!player.hasPermission(Permissions.Admin)) {
                        player.send {
                            localization(player) {
                                this.mailErrorNo_permission_to_create_system_mail
                            }
                        }
                        return@clickEvent
                    }
...
fun modifyTriggersMenuPage(context: CreatingMailContext, player: Player) = menuPage {
    title {
        localization(player) {
            this.menuCreate_system_mailPageModify_triggersTitle
        }
    }
    lines(5)
    1 to 1 eq {
    ...
    3 to 2 eq {
        ...
        hoverText {
            title {
                localization(player) {
                    this.menuCreate_system_mailPageModify_triggersButtonOnline_in_range
                }
            }
            description {
                ...
                if (trigger != null) {
                    ...
                    localization(
                        ...
                        this.menuCreate_system_mailPageModify_triggersButtonOnline_in_rangeDescription
                    }
                    newline()
                    localization(player) {
                        this.menuCreate_system_mailButtonModify_dateDescriptionTooltip1
                    ...
                    newline()
                    localization(player) {
                        this.menuCreate_system_mailPageModify_triggersButtonDescriptionNot_set
                    }
                    newline()
                    localization(player) {
                        this.menuCreate_system_mailButtonModify_dateDescriptionTooltip1
    ...
    3 to 5 eq {
        ...
        hoverText {
            title {
                localization(player) {
                    this.menuCreate_system_mailPageModify_triggersButtonOnline_before
                }
            }
            description {
                ...
                if (trigger != null) {
                    ...
                    localization(
                        ...
                        this.menuCreate_system_mailPageModify_triggersButtonOnline_beforeDescription
                    }
                    newline()
                    localization(player) {
                        this.menuCreate_system_mailButtonModify_dateDescriptionTooltip1
    ...
    3 to 8 eq {
        ...
        hoverText {
            title {
                localization(player) {
                    this.menuCreate_system_mailPageModify_triggersButtonOnline_in_days
                }
            }
            description {
                ...
                if (trigger != null) {
                    ...
                    if (trigger.days == 0) {
                        localization(
                            ...
                            this.menuCreate_system_mailPageModify_triggersButtonOnline_in_daysDescription_0days
                        }
                    } else {
                        localization(
                            player = player,
                            ...
                            this.menuCreate_system_mailPageModify_triggersButtonOnline_in_daysDescription
                        }
                    }
                    newline()
                    localization(player) {
...
fun modifyOnlineInRangeTrigger(context: CreatingMailContext, trigger: OnlineInRangeTrigger, player: Player) = menuPage {
    title {
        localization(player) {
            this.menuCreate_system_mailPageModify_triggersSub_pageModify_online_in_rangeTitle
        }
    }
    lines(5)
    1 to 1 eq {
    ...
    3 to 3 eq {
        ...
        hoverText {
            title {
                localization(player) {
                    this.menuCreate_system_mailPageModify_triggersSub_pageModify_online_in_rangeButtonModify_from
                }
            }
            description {
                newline()
    ...
    3 to 7 eq {
        ...
        hoverText {
            title {
                localization(player) {
                    this.menuCreate_system_mailPageModify_triggersSub_pageModify_online_in_rangeButtonModify_to
                }
            }
            description {
                newline()
...
fun modifyOnlineInRecentDaysTrigger(context: CreatingMailContext, trigger: OnlineInRecentDaysTrigger, player: Player) =
    menuPage {
        title {
            localization(player) {
                this.menuCreate_system_mailPageModify_triggersSub_pageModify_online_in_recent_daysTitle
            }
        }
        lines(5)
        1 to 1 eq {
        ...
        3 to 7 eq {
            ...
            hoverText {
                title {
                    localization(player) {
                        this.menuCreate_system_mailPageModify_triggersSub_pageModify_online_in_recent_daysButtonModify_days
                    }
                }
                description {
                    newline()
                    localization(
                        ...
                        this.menuCreate_system_mailPageModify_triggersSub_pageModify_online_in_recent_daysButtonModify_daysDescription
                    }
                }
            }
            clickEvent { clickContext ->
