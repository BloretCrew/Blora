                    ...
                    guild.withLock {
                        DB.trans {
                            ...
                            if (guild.bankBalance > guild.bankBalanceMax) {
                                ...
                                val formula =
                                    FormulaTokenizer.parse(CONF.guild.vitality.bankBalanceNewMaxVitalityFormula)
                                if (formula == null) {
                            ...
                            if (playerBalance.contribution > 0) {
                                val delta = (if (oldContribution <= 0)
                                    ...
                                    amount / 2).toDouble()
                                val formula =
                                    FormulaTokenizer.parse(CONF.guild.vitality.playerContributionVitalityFormula)
                                if (formula == null) {
