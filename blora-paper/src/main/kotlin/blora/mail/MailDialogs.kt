...
fun modifyMailTitleDialog(player: Player, menu: Menu, context: CreatingMailContext): Dialog {
    return ConfirmationDialog(
        title = component {
            localization(player) {
                this.mail.dialogModify_titleTitle
            }
        },
        inputs = listOf(
            TextInputControl(
                ...
                label = component {
                    localization(player) {
                        this.mail.dialogModify_titleInputPlaceholderTitle
                    }
                },
...
fun modifyMailSystemSenderDialog(player: Player, menu: Menu, context: CreatingMailContext): Dialog {
    return ConfirmationDialog(
        title = component {
            localization(player) {
                this.mail.dialogModify_system_senderTitle
            }
        },
        inputs = listOf(
            TextInputControl(
                ...
                label = component {
                    localization(player) {
                        this.mail.dialogModify_system_senderInputPlaceholderSystem_sender
                    }
                },
...
fun modifyMailContentsDialog(player: Player, menu: Menu, context: CreatingMailContext): Dialog {
    return ConfirmationDialog(
        title = component {
            localization(player) {
                this.mail.dialogModify_contentsTitle
            }
        },
        inputs = listOf(
            TextInputControl(
                ...
                label = component {
                    localization(player) {
                        this.mail.dialogModify_contentsInputPlaceholderContents
                    }
                },
    ...
    return ConfirmationDialog(
        ...
        inputs = listOf(
            TextInputControl(
                ...
                label = component {
                    localization(player) {
                        this.mail.dialogModify_dateInputPlaceholderYear
                    }
                }
            ),
            NumberRangeInputControl(
                ...
                label = component {
                    localization(player) {
                        this.mail.dialogModify_dateInputPlaceholderMonth
                    }
                },
                start = 1f,
                end = 12f,
            ...
            NumberRangeInputControl(
                ...
                label = component {
                    localization(player) {
                        this.mail.dialogModify_dateInputPlaceholderDay
                    }
                },
                start = 1f,
                end = 31f,
                    ...
                    if (year == null) {
                        player.openDialog(
                            modifyDateDialog(player, component {
                                localization(player) {
                                    this.mail.dialogModify_dateWarningYear_must_be_no_negative_digital
                                }
                        ...
                        player.openDialog(
                            modifyDateDialog(player, component {
                                localization(
                                    ...
                                    this.mail.dialogModify_dateWarningDay_out_of_limit
                                }
                            }, title, yesCallback, noCallback)
                        )
                        return@DynamicCustomClickTypeInjected
    ...
    return ConfirmationDialog(
        ...
        inputs = listOf(
            ...
            NumberRangeInputControl(
                ...
                label = component {
                    localization(player) {
                        this.mail.dialogModify_datetimeInputPlaceholderHour
                    }
                },
                start = 0f,
                end = 23f,
            ...
            NumberRangeInputControl(
                ...
                label = component {
                    localization(player) {
                        this.mail.dialogModify_datetimeInputPlaceholderMinute
                    }
                },
                start = 0f,
                end = 59f,
            ...
            NumberRangeInputControl(
                ...
                label = component {
                    localization(player) {
                        this.mail.dialogModify_datetimeInputPlaceholderSecond
                    }
                },
                start = 0f,
                end = 59f,
                ...
                if (date > trigger.to) {
                    player.openDialog(
                        modifyOnlineInRangeDialog(
                            ...
                            component {
                                localization(player) {
                                    this.mail.menuCreate_system_mailPageModify_triggersSub_pageModify_online_in_rangeWarningFrom_later_than_to
                                }
                            },
                            title,
                            yesCallback,
    ...
    return ConfirmationDialog(
        ...
        inputs = listOf(
            TextInputControl(
                ...
                label = component {
                    localization(player) {
                        this.mail.dialogModify_daysInputPlaceholderDays
                    }
                }
            ),
        ),
                    ...
                    if (days == null) {
                        player.openDialog(
                            modifyDaysDialog(player, component {
                                localization(player) {
                                    this.mail.menuCreate_system_mailPageModify_triggersSub_pageModify_online_in_recent_daysWarningDays_must_be_non_negative
                                }
                            }, title, yesCallback, noCallback)
                        )
                        return@DynamicCustomClickTypeInjected
    ...
    return ConfirmationDialog(
        ...
        inputs = listOf(
            TextInputControl(
                ...
                label = component {
                    localization(player) {
                        this.mail.dialogModify_amountInputPlaceholderAmount
                    }
                }
            ),
        ),
                    ...
                    if (amount == null) {
                        player.openDialog(
                            modifyAmountDialog(player, component {
                                localization(player) {
                                    this.mail.dialogModify_amountWarningMust_be_uint
                                }
                            }, title, yesCallback, noCallback)
                        )
                        return@DynamicCustomClickTypeInjected
...
fun setSystemMailIdentifierDialog(
    ...
    return ConfirmationDialog(
        title = component {
            localization(player) {
                this.mail.dialogSet_system_mail_identifierTitle
            }
        },
        body = if (warningMessage != null)
            listOf(
        ...
        inputs = listOf(
            TextInputControl(
                ...
                label = component {
                    localization(player) {
                        this.mail.dialogSet_system_mail_identifierInputPlaceholderIdentifier
                    }
                }
            )
        ),
                ...
                callback = {
                    ...
                    if (!id.matches("[a-zA-Z][a-zA-Z0-9_]*".toRegex())) {
                        player.openDialog(
                            setSystemMailIdentifierDialog(
                                ...
                                component {
                                    localization(player) {
                                        this.mail.dialogSet_system_mail_identifierWarningIdentifier_illegal
                                    }
                                }
                            )
                        )
                    ...
                    if (BloraPlugin.database.isSystemMailIdUsed(id)) {
                        player.openDialog(
                            setSystemMailIdentifierDialog(
                                ...
                                component {
                                    localization(player) {
                                        this.mail.dialogSet_system_mail_identifierWarningIdentifier_exists
                                    }
                                }
                            )
                        )
                    ...
                    player.send {
                        localization(
                            ...
                            this.mail.mailSuccessCreate_system_mail
                        }
                    }
                }
            )
                ...
                this.add(
                    PlainMessageDialogBody(
                        contents = component {
                            localization(player) {
                                if (mail.isClaim) {
                                    this.mail.mailViewAttachment_claimed
                                } else {
                                    this.mail.mailViewAttachment
                                }
                            }
        ...
        actions = buildList {
            if (!mail.parsedAttachment.hasNoContent() && !mail.isClaim) {
                this.add(
                    ClickAction(
                        label = component {
                            localization(player) {
                                this.mail.menuMail_listButtonClaim
                            }
                        },
                        action = DynamicCustomClickTypeInjected(
                            callback = {
                                ...
                                if (!mail.parsedAttachment.isClaimableOnThisServer()) {
                                    player.openDialog(
                                        playerViewMail(
                                            player,
                                            mail,
            ...
            this.add(
                ClickAction(
                    label = component {
                        localization(player) {
                            this.mail.menuMail_listButtonBack
                        }
                    }
                )
            )
