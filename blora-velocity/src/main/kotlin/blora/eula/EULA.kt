...
object EULA {
    ...
    val defaultContents: String = """
                            ...
                            <gold>
                            在您使用百络谷服务器提供的任何游戏服务之前，请确保您已详细阅读并接受本协议。注册百络谷服务器账号表示您已详细阅读并接受本协议。若您不同意该协议中的任何内容，请勿游玩百络谷服务器或接受其提供的任何相关服务。
                            </gold>
    ...
    fun saveDefault() {
        val eulaFile = File(BloraPlugin.dataDirectory.toFile(), "eula.mini")
        if (!eulaFile.exists()) {
            eulaFile.createNewFile()
            eulaFile.writeText(defaultContents)
        }
    }
