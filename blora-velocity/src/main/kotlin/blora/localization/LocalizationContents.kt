...
data class LocalizationContents(
    ...
    val commandErrorResetpassword_player_online: String = "该玩家当前在线，请先让其下线后再重置密码",
    val commandErrorResetpassword_not_registered: String = "该玩家尚未设置密码，无需重置",
    val commandSuccessResetpassword: String = "已重置玩家 <player> 的密码，其下次上线需重新注册",
    val commandErrorChangepassword_not_registered: String = "你尚未设置密码，无法修改",
    val commandErrorChangepassword_premium_no_password: String = "您是正版玩家且已自动登录，无需设置密码",
    val commandSuccessChangepassword: String = "<green>密码修改成功",
    val warningChangepassword_old_incorrect: String = "原密码错误",
    val warningChangepassword_same_as_old: String = "新密码不能与原密码相同",
    val titleDialogChange_password: String = "修改密码",
    val inputDialogChange_passwordOld: String = "原密码",
    val inputDialogChange_passwordNew: String = "新密码",
    val inputDialogChange_passwordConfirm: String = "确认新密码",
